...
OUTPUT_DIR = Path("results/semantic/roberta")
...
print("=" * 50)
print("RoBERTa — TEST SET METRICS")
print("=" * 50)
...
pd.DataFrame({
    ...
    "label": test_labels,
}).to_parquet(OUTPUT_DIR / "roberta_scores_test.parquet", index=False)
...
with open(OUTPUT_DIR / "roberta_eval_report.json", "w") as f:
    json.dump(report, f, indent=2)

print("Saved: model/, roberta_scores_test.parquet, roberta_eval_report.json")
